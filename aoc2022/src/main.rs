...
fn run_day16() {
    let result = day16::run_part_1();
    println!("done! {result}");
    let result = day16::run_part_2();
    println!("done! {result}");
}

fn run_day15() {
    let result = day15::run_part_1();
    println!("done! {result}");
    let result = day15::run_part_2();
    println!("done! {result}");
}

fn run_day14() {
    let contents = fs::read_to_string("inputs/day14.txt").expect("should open file");
    let result = day14::run_part_1(&contents);
    println!("done! {result}");
    let result = day14::run_part_2(&contents);
    println!("done! {result}");
}
...
fn run_day12() {
    let contents = fs::read_to_string("inputs/day12.txt").expect("should open file");
    let result = day12::run_part_1(&contents);
    println!("done! {result}");
    let result = day12::run_part_2(&contents);
    println!("done! {result}");
}
